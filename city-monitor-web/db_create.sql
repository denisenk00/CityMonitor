...
ALTER TABLE OPTIONS ADD CONSTRAINT has_options FOREIGN KEY (quiz_id) REFERENCES QUIZZES (quiz_id) ON DELETE CASCADE;
...
ALTER TABLE RESULTS ADD CONSTRAINT for_option FOREIGN KEY (option_id) REFERENCES OPTIONS (option_id) ON DELETE CASCADE;
